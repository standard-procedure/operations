...
Gem::Specification.new do |spec|
  spec.name = "operations-activerecord"
  spec.version = Operations::VERSION
  spec.authors = ["Rahoul Baruah"]
  spec.email = ["rahoulb@echodek.co"]
  spec.homepage = "https://theartandscienceofruby.com/"
  spec.summary = "ActiveRecord storage adapter for Operations"
  spec.description = "Provides ActiveRecord-based persistence for Operations tasks"
  spec.license = "LGPL"
